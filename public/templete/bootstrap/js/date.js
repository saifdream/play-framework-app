...
myapp.constant('uiDateConfig', {})

myapp.directive('uiDate', ['uiDateConfig', 'uiDateConverter', function (uiDateConfig, uiDateConverter) {
  'use strict';
  var options;
  options = {};
...
myapp.factory('uiDateConverter', ['uiDateFormatConfig', function(uiDateFormatConfig){
...
myapp.constant('uiDateFormatConfig', '')
myapp.directive('uiDateFormat', ['uiDateConverter', function(uiDateConverter) {
  var directive = {
    require:'ngModel',
