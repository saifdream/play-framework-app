...
.controller("example-ctrl", ["$scope", "$filter", function($scope, $filter) {
	...
	angular.module("angular-table-example").controller("basicExampleCtrl", ["$scope", function($scope) {
	  ...
	  $scope.updateFilteredId = function() {
	    $scope.filteredList = $filter("filter")($scope.originalList, $scope.id);
	  };
	  
	  $scope.updateFilteredName = function() {
		$scope.filteredList = $filter("filter")($scope.originalList, $scope.name);
	  };
	  
	  $scope.updateFilteredAge = function() {
		$scope.filteredList = $filter("filter")($scope.originalList, $scope.age);
	  };
		  
	  $scope.updateFilteredBirthdate = function() {
		$scope.filteredList = $filter("filter")($scope.originalList, $scope.birthdate);
	  };
